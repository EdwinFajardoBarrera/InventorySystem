 ...
 */
public class ProduccionView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Producto producido");

        JCBProducto.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setText("Cantidad - Galones");
        ...
        JBNuevoProducto.setBackground(new java.awt.Color(0, 153, 0));
        JBNuevoProducto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        JBNuevoProducto.setForeground(new java.awt.Color(255, 255, 255));
        JBNuevoProducto.setText("+ Agregar nuevo producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduccionView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
